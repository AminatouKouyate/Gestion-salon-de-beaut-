...
<div class="beauty-page-header">
    <div class="beauty-page-header-left">
        ...
        <div>
            <h2 class="beauty-page-title">Ajouter un service </h2>
            <p class="beauty-page-subtitle">Créer une nouvelle prestation</p>
        </div>
    </div>
    ...
    <div class="beauty-card-body">
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="category" id="category" class="form-control @error('category') is-invalid @enderror">
                        ...
                        <option value="coiffure" @if(old('category') == 'coiffure') selected @endif>Coiffure</option>
                        <option value="maquillage" @if(old('category') == 'maquillage') selected @endif>Maquillage</option>
                        <option value="soin" @if(old('category') == 'soin') selected @endif>Soin</option>
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror">
                        <option value="mixte" @if(old('gender', 'mixte') == 'mixte') selected @endif>Mixte (Tous)</option>
                        <option value="homme" @if(old('gender') == 'homme') selected @endif>Homme</option>
                        <option value="femme" @if(old('gender') == 'femme') selected @endif>Femme</option>
                        <option value="enfant" @if(old('gender') == 'enfant') selected @endif>Enfant</option>
                    </select>
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">Vous pouvez sélectionner plusieurs images (JPG, PNG, max 2Mo chacune)</small>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="form-check py-1">
                                    <input type="checkbox" name="employees[]" value="{{ $employee->id }}"
                                           ...
                                           @if(in_array($employee->id, old('employees', []))) checked @endif>
